...
- [Arquitectura-Medallón.md](/Arquitectura-Medallón.md): Pipeline de transformación y cruce de datos.
- [incremental-clima.py](/Scripts/incremental-clima.py): Scraping y procesamiento de históricos AEMET.

### 3. Visualización y Análisis
- [Visualización-Datos.md](/Visualización-Datos.md): Análisis exploratorio (EDA) y Dashboard con Altair.
